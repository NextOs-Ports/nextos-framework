# Pikmin — referência NextOS

[English](README.en.md)

[Catálogo](../../catalog/README.md) · [Guia para IA](../../docs/pt-BR/PORTAR-COM-IA.md) · [Fontes selecionadas](upstream/)

Origem: [pikmin-nextos](https://github.com/NextOs-Ports/pikmin-nextos), commit `1e6af10318a73f4db8251c52241ad868583891d3`. Plataforma: GameCube.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 28 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
...
LICENSE concede MIT somente às contribuições NextOS; descreve projectPiki CC0 e exclusões do código reconstruído. Redistribuição da árvore inteira não foi liberada neste estudo.
