**Prizefighters 2 — referência NextOS**

Fonte: [prizefighters2-nextos](https://github.com/NextOs-Ports/prizefighters2-nextos), commit `53371b37dc5d01e0a8c09d683536ee1c48f35d6c`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 174 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
