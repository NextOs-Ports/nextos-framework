# Prizefighters 2 — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [prizefighters2-nextos](https://github.com/NextOs-Ports/prizefighters2-nextos), commit `53371b37dc5d01e0a8c09d683536ee1c48f35d6c`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 174 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
