# Magic Rampage — referência NextOS
...
Origem: [magicrampage-nextos](https://github.com/NextOs-Ports/magicrampage-nextos), commit `852f6be8617699194ad96944c7f028a752ab5dad`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 40 arquivos incluídos e 3 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
