# Magic Rampage — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [magicrampage-nextos](https://github.com/NextOs-Ports/magicrampage-nextos), commit `852f6be8617699194ad96944c7f028a752ab5dad`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 40 files are included and 3 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
