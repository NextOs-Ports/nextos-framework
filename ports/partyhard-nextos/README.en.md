# Party Hard GO — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [partyhard-nextos](https://github.com/NextOs-Ports/partyhard-nextos), commit `0a03b8483ac9c84d3be63c8dd898cf5acd305576`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 265 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
