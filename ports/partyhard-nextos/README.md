**Party Hard GO — referência NextOS**

Fonte: [partyhard-nextos](https://github.com/NextOs-Ports/partyhard-nextos), commit `0a03b8483ac9c84d3be63c8dd898cf5acd305576`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 265 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
