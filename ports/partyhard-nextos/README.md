...
Origem: [partyhard-nextos](https://github.com/NextOs-Ports/partyhard-nextos), commit `0a03b8483ac9c84d3be63c8dd898cf5acd305576`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 265 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
