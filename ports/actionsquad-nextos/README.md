**Door Kickers: Action Squad — referência NextOS**

Fonte: [actionsquad-nextos](https://github.com/NextOs-Ports/actionsquad-nextos), commit `842efc61a47192cd3ac4d3062dbe9c32e808c791`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 72 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
