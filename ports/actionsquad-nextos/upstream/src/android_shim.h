 ...
 * in the game's native library can run on Linux ARM64.
 */
...
/* Resolucao real do surface (definidas no egl_shim). */
extern int coi_screen_w, coi_screen_h;

/* ---------- Action Squad ----------
 * SetHaveController(count, name, deviceId) e' um metodo NATIVO que o Java
 * chamava a cada evento do InputManager; o nome alimenta GetControllerType.
 * Ver MEDIDAS.md. */
