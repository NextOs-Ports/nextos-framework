**Huntdown — referência NextOS**

Fonte: [huntdown-nextos](https://github.com/NextOs-Ports/huntdown-nextos), commit `7eef080e69a66a09efc005bf3472035eef09248b`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 124 arquivos incluídos e 4 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
