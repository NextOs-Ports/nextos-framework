...
Origem: [huntdown-nextos](https://github.com/NextOs-Ports/huntdown-nextos), commit `7eef080e69a66a09efc005bf3472035eef09248b`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 124 arquivos incluídos e 4 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
