/*
 * jni_shim.h -- minimal JNI environment for Huntdown/Unity
 *
...
// Unity soft-keyboard bridge used by Android input fields.
...
// Processa callbacks Java assíncronos no thread da Unity, fora de nativeRender.
...
// Flush the Android SharedPreferences replacement before process teardown.
...
/* Stable fake-JNI objects used by libmain's NativeLoader entry point. */
void *jni_shim_string(const char *value);
