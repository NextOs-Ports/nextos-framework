# Horizon Chase — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [horizonchase-nextos](https://github.com/NextOs-Ports/horizonchase-nextos), commit `59d2d38dc496ae0a71726181d3ccc80923e4144d`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 88 files are included and 2 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
