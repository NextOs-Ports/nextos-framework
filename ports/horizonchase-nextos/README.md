# Horizon Chase — referência NextOS

[English](README.en.md)

[Catálogo](../../catalog/README.md) · [Guia para IA](../../docs/pt-BR/PORTAR-COM-IA.md) · [Fontes selecionadas](upstream/)

Origem: [horizonchase-nextos](https://github.com/NextOs-Ports/horizonchase-nextos), commit `59d2d38dc496ae0a71726181d3ccc80923e4144d`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 88 arquivos incluídos e 2 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
