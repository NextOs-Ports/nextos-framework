# Suzy Cube — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [suzycube-nextos](https://github.com/NextOs-Ports/suzycube-nextos), commit `c3db13c749173e08d33d57839aca961d0a2ab319`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 56 files are included and 2 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
