# Streets of Rage 4 — referência NextOS

[English](README.en.md)

[Catálogo](../../catalog/README.md) · [Guia para IA](../../docs/pt-BR/PORTAR-COM-IA.md) · [Fontes selecionadas](upstream/)

Origem: [sor4-nextos](https://github.com/NextOs-Ports/sor4-nextos), commit `3c17968325ec40a3f910ca690ab0b4cab76ae950`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 127 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
