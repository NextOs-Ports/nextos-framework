# Angry Birds Classic — referência NextOS
...
Origem: [angrybirds-nextos](https://github.com/NextOs-Ports/angrybirds-nextos), commit `74af40a86d09126e5e2c3b220102411c44407fd5`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 138 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
