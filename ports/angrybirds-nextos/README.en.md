# Angry Birds Classic — NextOS reference
...
Origin: [angrybirds-nextos](https://github.com/NextOs-Ports/angrybirds-nextos), commit `74af40a86d09126e5e2c3b220102411c44407fd5`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 138 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
