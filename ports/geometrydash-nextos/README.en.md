# Geometry Dash / Geometry Dash SubZero — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [geometrydash-nextos](https://github.com/NextOs-Ports/geometrydash-nextos), commit `8fc62be4c2e19f204cc846ff6e979c78fe1bcbd7`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 83 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
