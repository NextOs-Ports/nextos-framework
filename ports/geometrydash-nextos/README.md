...
Origem: [geometrydash-nextos](https://github.com/NextOs-Ports/geometrydash-nextos), commit `8fc62be4c2e19f204cc846ff6e979c78fe1bcbd7`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 83 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
