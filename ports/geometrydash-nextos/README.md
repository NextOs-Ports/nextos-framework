**Geometry Dash + Geometry Dash SubZero — referência NextOS**

Fonte: [geometrydash-nextos](https://github.com/NextOs-Ports/geometrydash-nextos), commit `8fc62be4c2e19f204cc846ff6e979c78fe1bcbd7`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 83 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
