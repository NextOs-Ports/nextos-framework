...
# Os menus destes ports sao de toque: a seta anda com o analogico DIREITO, e
# so' o R3 toca. Sem passo de eixo nao da' para chegar num botao que nao esteja
# no centro da tela.
STICK = {
    "rstick_up": (0x04, -28000), "rstick_down": (0x04, 28000),
    "rstick_left": (0x03, -28000), "rstick_right": (0x03, 28000),
    "lstick_up": (0x01, -28000), "lstick_down": (0x01, 28000),
    "lstick_left": (0x00, -28000), "lstick_right": (0x00, 28000),
}
HAT = {
...
def _run(fd, script):
    ...
    for step in script.split(","):
        ...
        for k in parts:
            if k in STICK:
                emit(EV_ABS, STICK[k][0], STICK[k][1])
            elif k in HAT:
