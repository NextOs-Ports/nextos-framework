...
printf 'Directed invocation fixture; output: %s\n' "$fixture_build" >&2
"$host_cxx" -std=c++17 -O2 -fno-strict-aliasing -I"$study_root/prototype" \
  "$study_root/tools/host_invocation_fixture.cpp" "$study_root/prototype/macho_loader.cpp" \
  "$study_root/prototype/darwin_libc.cpp" -ldl -pthread -o "$fixture_build/invocation-test"
"$fixture_build/invocation-test" "$2"
