...
Origem: [rcrdx-nextos](https://github.com/NextOs-Ports/rcrdx-nextos), commit `7d79b145f9c271ac5bbf959fb254880482ac99a1`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 55 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
