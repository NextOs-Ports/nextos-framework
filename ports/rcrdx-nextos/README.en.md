# Retro City Rampage DX — NextOS reference
...
Origin: [rcrdx-nextos](https://github.com/NextOs-Ports/rcrdx-nextos), commit `7d79b145f9c271ac5bbf959fb254880482ac99a1`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 55 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
