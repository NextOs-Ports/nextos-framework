...
## Source and licenses / Fonte e licenças

Project sources are under `src/`. The compatibility loader is GPL-3.0-only.
NXExtract and NXSplash notices are included in `licenses/`. Retro City Rampage
DX remains the property of its respective owner.
