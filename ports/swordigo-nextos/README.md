**Swordigo — referência NextOS**

Fonte: [swordigo-nextos](https://github.com/NextOs-Ports/swordigo-nextos), commit `28b315f08652db71f35158ae3af454d470ae624f`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 63 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
