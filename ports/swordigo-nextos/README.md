...
Origem: [swordigo-nextos](https://github.com/NextOs-Ports/swordigo-nextos), commit `28b315f08652db71f35158ae3af454d470ae624f`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 63 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
