# Final Fantasy IV (3D Remake) / Final Fantasy IV: The After Years — referência NextOS

[English](README.en.md)

[Catálogo](../../catalog/README.md) · [Guia para IA](../../docs/pt-BR/PORTAR-COM-IA.md) · [Fontes selecionadas](upstream/)

Origem: [ff4-nextos](https://github.com/NextOs-Ports/ff4-nextos), commit `58806cdbee0a37709969559d154b025a222c6bd8`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 79 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
...
Detector sem licença na raiz; GPLv3 em ff4/LICENSE e ff4a/LICENSE. Revisão por arquivo pendente.
