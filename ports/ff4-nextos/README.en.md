# Final Fantasy IV (3D Remake) / Final Fantasy IV: The After Years — NextOS reference
...
Origin: [ff4-nextos](https://github.com/NextOs-Ports/ff4-nextos), commit `58806cdbee0a37709969559d154b025a222c6bd8`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 79 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
...
Root license detection null; GPLv3 text found in ff4/LICENSE and ff4a/LICENSE. Per-file review remains.
