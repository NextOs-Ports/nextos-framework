# Installation — Final Fantasy IV The After Years

## English

This port ships the runtime only. The game itself is **not** included and is
not distributed here: Final Fantasy IV The After Years, its engine, its OBB, its art and its audio
...
| App version | `1.0.12` |
| Size | 480217369 bytes |
| SHA-256 | `fd98681e985164f5c67903bcd2ddb20db8e1b194d467e049e6c67eb6bbd6358f` |
| ABI used | `arm64-v8a` |
...
- aarch64 CFW with glibc 2.17 or newer
...
distribuído aqui: Final Fantasy IV The After Years, sua engine, o OBB, a arte e o áudio pertencem à
...
| Campo | Valor |
|---|---|
| Pacote | `com.square_enix.android_googleplay.FF4AY_GP` |
| Versão do app | `1.0.12` |
| Tamanho | 480217369 bytes |
| SHA-256 | `fd98681e985164f5c67903bcd2ddb20db8e1b194d467e049e6c67eb6bbd6358f` |
| ABI usada | `arm64-v8a` |
...
- CFW aarch64 com glibc 2.17 ou mais nova
