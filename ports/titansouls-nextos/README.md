**Titan Souls — referência NextOS**

Fonte: [titansouls-nextos](https://github.com/NextOs-Ports/titansouls-nextos), commit `b697a51fde1ba32ab6f8eb5c246e6eb88bc19be3`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 77 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
