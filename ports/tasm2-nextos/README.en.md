# The Amazing Spider-Man 2 — NextOS reference
...
Origin: [tasm2-nextos](https://github.com/NextOs-Ports/tasm2-nextos), commit `efcad10d4d525ed593d34a1463021a41a780e7f0`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 2668 files are included and 1 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
