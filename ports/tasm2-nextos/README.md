# The Amazing Spider-Man 2 — referência NextOS
...
Origem: [tasm2-nextos](https://github.com/NextOs-Ports/tasm2-nextos), commit `efcad10d4d525ed593d34a1463021a41a780e7f0`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 2668 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
