# ScourgeBringer — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [scourgebringer-nextos](https://github.com/NextOs-Ports/scourgebringer-nextos), commit `94bc81622e5261ce23a7f5fee314d441e7c320a1`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 72 files are included and 2 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
