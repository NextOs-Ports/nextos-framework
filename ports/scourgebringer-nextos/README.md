**ScourgeBringer — referência NextOS**

Fonte: [scourgebringer-nextos](https://github.com/NextOs-Ports/scourgebringer-nextos), commit `94bc81622e5261ce23a7f5fee314d441e7c320a1`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 72 arquivos incluídos e 2 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
