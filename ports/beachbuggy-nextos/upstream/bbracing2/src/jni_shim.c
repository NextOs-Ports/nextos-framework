...
enum {
  ...
  MID_LOAD_CLASS,
  MID_GET_CONTENT_RESOLVER,
  MID_SETTINGS_GET_STRING,
...
static void *get_method_id(void *env, void *cls, const char *name, const char *sig) {
  ...
  if (!strcmp(name, "getContentResolver")) return (void *)(uintptr_t)MID_GET_CONTENT_RESOLVER;
  if (!strcmp(name, "getString")) return (void *)(uintptr_t)MID_SETTINGS_GET_STRING;
  if (!strcmp(name, "getPackageName")) return (void *)(uintptr_t)MID_GET_PACKAGE_NAME;
  if (!strcmp(name, "getPackageManager")) return (void *)(uintptr_t)MID_GET_PACKAGE_MANAGER;
  if (!strcmp(name, "getPackageInfo")) return (void *)(uintptr_t)MID_GET_PACKAGE_INFO;
...
static void *get_field_id(void *env, void *cls, const char *name, const char *sig) {
  ...
  if (!strcmp(name, "ANDROID_ID")) return (void *)(uintptr_t)FID_ANDROID_ID;
  if (!strcmp(name, "MANUFACTURER")) return (void *)(uintptr_t)FID_MANUFACTURER;
  if (!strcmp(name, "MODEL")) return (void *)(uintptr_t)FID_MODEL;
  if (!strcmp(name, "WINDOW_SERVICE")) return (void *)(uintptr_t)FID_WINDOW_SERVICE;
  if (!strcmp(name, "versionName")) return (void *)(uintptr_t)FID_VERSION_NAME;
  if (!strcmp(name, "versionCode")) return (void *)(uintptr_t)FID_VERSION_CODE;
...
static void *call_object_method_v(void *env, void *obj, void *methodID, va_list args) {
  ...
  switch (mid) {
    ...
    case MID_GET_CONTENT_RESOLVER:
      return (void *)(uintptr_t)CLASS_RESOURCES;
    case MID_SETTINGS_GET_STRING:
      return jni_new_string_utf("nextos-bbracing2");
    case MID_GET_PACKAGE_NAME:
      return jni_new_string_utf("com.vectorunit.cobalt.googleplay");
    case MID_GET_PACKAGE_MANAGER:
      return (void *)(uintptr_t)CLASS_RESOURCES;
    case MID_GET_PACKAGE_INFO:
      return (void *)(uintptr_t)CLASS_MAIN_ACTIVITY;
    ...
    case MID_SYS_GET_VERSION:
      return jni_new_string_utf("2026.07.31");
...
static void *get_static_object_field(void *env, void *cls, void *fieldID) {
  (void)env;
  (void)cls;
  switch ((uintptr_t)fieldID) {
    case FID_ANDROID_ID:
      return jni_new_string_utf("android_id");
    case FID_MANUFACTURER:
      return jni_new_string_utf("NextOS");
    case FID_MODEL:
      return jni_new_string_utf("Mali-450");
    case FID_WINDOW_SERVICE:
      return jni_new_string_utf("window");
    default:
      return NULL;
  }
}

static void *get_object_field(void *env, void *obj, void *fieldID) {
  (void)env;
  (void)obj;
  if ((uintptr_t)fieldID == FID_VERSION_NAME)
    return jni_new_string_utf("2026.07.31");
  return NULL;
}
...
static jint get_int_field(void *env, void *obj, void *fieldID) {
  ...
  if (fid == FID_VERSION_CODE) return 20260731;
  return 0;
}
...
void jni_shim_init(void **out_vm, void **out_env) {
  ...
  jni_env_vtable[95]  = (uintptr_t)get_object_field;             // GetObjectField
  ...
  jni_env_vtable[145] = (uintptr_t)get_static_object_field;      // GetStaticObjectField
