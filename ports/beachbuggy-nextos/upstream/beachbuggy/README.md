# Beach Buggy Racing — NextOS universal port

## English

### Overview

BYO-data port of **Beach Buggy Racing** (Vector Unit) for aarch64 CFW
...
nxbootstrap launcher (single visible .sh)
  ...
  -> beachbuggy loader (aarch64, GLIBC <= 2.30)
...
Port BYO-data de **Beach Buggy Racing** (Vector Unit) para portáteis aarch64
...
- `A`: confirmar / power-up · `R1`/`R2`: acelerar · `L1`/`L2`: frear
