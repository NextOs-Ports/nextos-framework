# Beach Buggy Racing / Beach Buggy Racing 2 — NextOS reference
...
Origin: [beachbuggy-nextos](https://github.com/NextOs-Ports/beachbuggy-nextos), commit `2d6a2dc040711c801ba43ed3a407d2093e713fb6`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 80 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
...
Root license detection null; GPLv3 text found in beachbuggy/LICENSE and bbracing2/LICENSE. Per-file review remains.
