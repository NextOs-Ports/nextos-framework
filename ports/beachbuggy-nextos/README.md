**Beach Buggy Racing + Beach Buggy Racing 2 — referência NextOS**

Fonte: [beachbuggy-nextos](https://github.com/NextOs-Ports/beachbuggy-nextos), commit `2d6a2dc040711c801ba43ed3a407d2093e713fb6`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 80 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
...
Licenças: Root license detection null; GPLv3 text found in beachbuggy/LICENSE and bbracing2/LICENSE. Per-file review remains.
