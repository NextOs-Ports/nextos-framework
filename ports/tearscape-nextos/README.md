...
Origem: [tearscape-nextos](https://github.com/NextOs-Ports/tearscape-nextos), commit `de162373a9e9d2e65880266b820a06971a9f87a3`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 152 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
