**Tearscape — referência NextOS**

Fonte: [tearscape-nextos](https://github.com/NextOs-Ports/tearscape-nextos), commit `de162373a9e9d2e65880266b820a06971a9f87a3`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 152 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
