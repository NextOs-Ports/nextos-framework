# Tearscape — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [tearscape-nextos](https://github.com/NextOs-Ports/tearscape-nextos), commit `de162373a9e9d2e65880266b820a06971a9f87a3`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 152 files are included and 1 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
