**Stardew Valley — referência NextOS**

Fonte: [stardewvalley-nextos](https://github.com/NextOs-Ports/stardewvalley-nextos), commit `7ac80b7648dca62f33594becef74d6d4d89f3b36`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 55 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
