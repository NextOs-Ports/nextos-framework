...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 91 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
