**Star Wars: Knights of the Old Republic — referência NextOS**

Fonte: [kotor-nextos](https://github.com/NextOs-Ports/kotor-nextos), commit `9d8dc0cdd3cf164a39f480200ab20a9a1117b91b`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 91 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
