# PartyBoard / Mario Party 4 — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [partyboard-nextos](https://github.com/NextOs-Ports/partyboard-nextos), commit `6ac391d61fda260aadb0c8b1e5f77d2ae5f0d797`. Platform: GameCube.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 27 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
...
LICENSE grants MIT only for NextOS contributions; explicitly excludes unlicensed upstream PartyBoard and reconstructed game code. Whole-tree redistribution not cleared by this study.
