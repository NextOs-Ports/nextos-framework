**Bomb Chicken + Gunbrick Reloaded — referência NextOS**

Fonte: [bombchicken-gunbrick-nextos](https://github.com/NextOs-Ports/bombchicken-gunbrick-nextos), commit `53df6041da4ecc4905af5ecd24551034eea21175`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 99 arquivos incluídos e 3 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
