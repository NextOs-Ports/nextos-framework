...
Origem: [deadtrigger-nextos](https://github.com/NextOs-Ports/deadtrigger-nextos), commit `8fe021e4188db177a074547473d7723e060748fe`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 44 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
