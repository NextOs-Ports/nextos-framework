**Dead Trigger — referência NextOS**

Fonte: [deadtrigger-nextos](https://github.com/NextOs-Ports/deadtrigger-nextos), commit `8fe021e4188db177a074547473d7723e060748fe`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 44 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
