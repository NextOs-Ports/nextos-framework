**Castle of Illusion — referência NextOS**

Fonte: [castleofillusion-nextos](https://github.com/NextOs-Ports/castleofillusion-nextos), commit `bbe0f6bf038be7960903dad7abb3b34c5baf5a10`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 46 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
