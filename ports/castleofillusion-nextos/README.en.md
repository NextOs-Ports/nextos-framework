# Castle of Illusion — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [castleofillusion-nextos](https://github.com/NextOs-Ports/castleofillusion-nextos), commit `bbe0f6bf038be7960903dad7abb3b34c5baf5a10`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 46 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
