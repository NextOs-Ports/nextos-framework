...
Origem: [namelesscat-nextos](https://github.com/NextOs-Ports/namelesscat-nextos), commit `fb489c406495e30822d50c8250c76810845414d5`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 142 arquivos incluídos e 3 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
