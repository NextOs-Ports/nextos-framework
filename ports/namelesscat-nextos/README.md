**Nameless Cat — referência NextOS**

Fonte: [namelesscat-nextos](https://github.com/NextOs-Ports/namelesscat-nextos), commit `fb489c406495e30822d50c8250c76810845414d5`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 142 arquivos incluídos e 3 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
