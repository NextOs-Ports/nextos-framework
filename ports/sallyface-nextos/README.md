...
Origem: [sallyface-nextos](https://github.com/NextOs-Ports/sallyface-nextos), commit `39f3d3bd7fed4f160ae20af0f8824ab6b71b79bf`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 93 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
