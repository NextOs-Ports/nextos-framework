 ...
 * before-present; a port that samples explicitly should use
 * nxgl_frame_proof_sample_at(). The "VIDEO:" receipt line gains an APPENDED
 * "sample_point=" field (before-present | after-present | unspecified |
 * mixed | none); every pre-existing field stays byte-identical. */
