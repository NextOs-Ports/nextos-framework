**Sonic the Hedgehog 4: Episode II — referência NextOS**

Fonte: [sonic4ep2-nextos](https://github.com/NextOs-Ports/sonic4ep2-nextos), commit `52ec4bfbf51753ccdc0706a901c1412c4a5a61e5`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 85 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
