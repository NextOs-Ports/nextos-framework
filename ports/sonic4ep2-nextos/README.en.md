# Sonic the Hedgehog 4: Episode II — NextOS reference
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 85 files are included and 1 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
