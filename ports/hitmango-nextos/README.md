**Hitman GO — referência NextOS**

Fonte: [hitmango-nextos](https://github.com/NextOs-Ports/hitmango-nextos), commit `3f735165348e17d4f9aa20f1d227a9b1ecb4efb8`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 81 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
