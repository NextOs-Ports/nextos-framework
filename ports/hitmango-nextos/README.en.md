# Hitman GO — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [hitmango-nextos](https://github.com/NextOs-Ports/hitmango-nextos), commit `3f735165348e17d4f9aa20f1d227a9b1ecb4efb8`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 81 files are included and 1 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
