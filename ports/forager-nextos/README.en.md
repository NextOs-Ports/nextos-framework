# Forager Nuclear — NextOS reference
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 56 files are included and 0 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
...
NOTICE.md explicitly identifies GPL version 2 only and gmloader-next origin. Do not merge code into GPLv3 components without compatibility resolution.
