# Forager Nuclear — referência NextOS

[English](README.en.md)

[Catálogo](../../catalog/README.md) · [Guia para IA](../../docs/pt-BR/PORTAR-COM-IA.md) · [Fontes selecionadas](upstream/) · [Guia do runtime Android](../../docs/pt-BR/GAMEMAKER-ANDROID.md)

Origem: [forager-nextos](https://github.com/NextOs-Ports/forager-nextos), commit `89e5c7107889f6b19a705f006f9f492bb0eb80da`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 56 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
...
NOTICE.md declara GPL versão 2 somente e origem gmloader-next. Não misturar código com componentes GPLv3 sem resolver compatibilidade.
