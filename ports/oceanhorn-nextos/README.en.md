# Oceanhorn: Chronos Dungeon — NextOS reference

[Português](README.md)

[Catalog](../../catalog/README.en.md) · [AI guide](../../docs/en/AI-PORTING.md) · [Selected sources](upstream/)

Origin: [oceanhorn-nextos](https://github.com/NextOs-Ports/oceanhorn-nextos), commit `7cb05cca86afbb4b8a6e76aa251c8f0f8397bc9e`. Platform: Android.
...
Read [SOURCE-MAP.json](SOURCE-MAP.json) before copying code: 61 files are included and 1 additional privacy/content omissions are recorded. Upstream recipes may require files outside this selection; cloning this directory does not guarantee a standalone build.
