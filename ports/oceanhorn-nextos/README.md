**Oceanhorn: Chronos Dungeon — referência NextOS**

Fonte: [oceanhorn-nextos](https://github.com/NextOs-Ports/oceanhorn-nextos), commit `7cb05cca86afbb4b8a6e76aa251c8f0f8397bc9e`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 61 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
