...
Origem: [oceanhorn-nextos](https://github.com/NextOs-Ports/oceanhorn-nextos), commit `7cb05cca86afbb4b8a6e76aa251c8f0f8397bc9e`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 61 arquivos incluídos e 1 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
