**Merchant of the Skies — referência NextOS**

Fonte: [merchantskies-nextos](https://github.com/NextOs-Ports/merchantskies-nextos), commit `213a3d9875158164bb532ef031651a052ab8360e`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 74 arquivos incluídos e 1 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
