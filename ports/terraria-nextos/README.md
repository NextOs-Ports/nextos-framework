...
Origem: [terraria-nextos](https://github.com/NextOs-Ports/terraria-nextos), commit `e04f6fe7d3be9591e659f6ecd42355d1b5d2caf6`. Plataforma: Android.
...
Leia [SOURCE-MAP.json](SOURCE-MAP.json) antes de copiar código: há 94 arquivos incluídos e 0 omissões adicionais registradas de privacidade/conteúdo. Receitas upstream podem exigir arquivos fora desta seleção; um clone desta pasta não garante build autônomo.
