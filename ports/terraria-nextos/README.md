**Terraria — referência NextOS**

Fonte: [terraria-nextos](https://github.com/NextOs-Ports/terraria-nextos), commit `e04f6fe7d3be9591e659f6ecd42355d1b5d2caf6`.
...
Consulte `SOURCE-MAP.json` para os arquivos preservados, seus hashes e as omissões. Há 94 arquivos incluídos e 0 omissões adicionais de privacidade/conteúdo. Algumas receitas upstream dependem de arquivos fora desta seleção; a compilação autônoma de cada referência ainda será revisada.
