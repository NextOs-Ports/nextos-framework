...
/* Provedor GLES1 falso MORTO: exporta todos os nomes mas glGetString
 * devolve NULL -- o blob orfao do ROCKNIX e a Mesa sem driver do dArkOS. */
...
const char *glGetString(unsigned name) { (void)name; return 0; }
