...
/* Provedor GLES1 falso VIVO: todos os nomes + glGetString que RESPONDE --
 * e' o criterio de vida do resolvedor 0.2.14. */
...
const char *glGetString(unsigned name) { (void)name; return "Fake Live GLES1"; }
