...
static const nxcompat_capability_definition nxcompat_capabilities[] = {
    ...
    {31u, "audio.embedded-openal", NXCOMPAT_PHASE_PREFLIGHT,
     NXCOMPAT_SOURCE_PROBE, NXCOMPAT_EVIDENCE_OBSERVED,
     NXCOMPAT_ROLE_PORT_DECLARED},
    /* Anexada no fim de proposito: os ids acima ja' viajaram em recibos
       gravados, e renumerar para deixar GLES1 ao lado de GLES2 quebraria a
       leitura deles. A ordem aqui espelha capabilities-v1.json. */
    {32u, "graphics.gles1", NXCOMPAT_PHASE_GRAPHICS, NXCOMPAT_SOURCE_NXGL,
     NXCOMPAT_EVIDENCE_OPENED, NXCOMPAT_ROLE_BASELINE_GRAPHICS}};
